---
title: "react-chat-window"
description: "react-chat-window provides an intercom-like chat window that can be included easily in any project for free.|https://www.npmjs.com/package/react-chat-window, https://github.com/dharness/react-chat-window"
...
It has 3k downloads/month on npm and 640 stars on github.

<img
  src="https://dharness-cdn.s3.us-west-2.amazonaws.com/react-chat-window-demo.gif"
  style={{ height: "66vh" }}
  alt="Demo gif of react-chat-window being used"
/>
